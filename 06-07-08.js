...
function crearClasePersona() {
  class Persona {
    constructor(nombre = "", edad = entero , hobbies, amigos) {
    ...
    getFriends() {
      ...
      // Tu código aca:
      let arr = this.amigos.map ( ele => ele.nombre);
      return arr;
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
        let promedio = this.amigos.map( elemento => elemento.edad).reduce((a,b) => a + b)/ this.amigos.length;
        return promedio;
